<template>
  <div :class="modelValue ? 'visible' : 'invisible'">
    <div
      class="fixed left-0 top-0 z-20 h-full w-full bg-black transition-all duration-300 ease-in-out"
    ...
    >
      <div class="bg-white z-50 w-auto m-auto p-4 rounded-lg">
        ...
        <div class="flex items-center justify-between">
          <a
            href="https://wa.me?text=https://links-coding-space.netlify.app/"
            target="_blank"
          >
        ...
        <div
          class="flex justify-between border-2 border-gray-200 rounded w-full mt-8 p-2 items-center"
          @click="shareLink()"
        >
          <Icon name="mdi:content-copy" />
          <p class="mx-4">links-coding-space.netlify.com</p>
          <p
            class="font-medium"
            :class="`${copy === 'Share' ? 'text-gray-800 ' : 'text-green-800'}`"
          >
            {{ copy }}
          </p>
        </div>
